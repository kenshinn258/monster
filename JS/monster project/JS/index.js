class BaseCharacter {
  ...
  getHurt(damage) {
    ...
    _this.id = setInterval(function() {
      ...
      _this.element.getElementsByClassName("effect-image")[0].src = 'img/blade/' + i + '.png';
      i++;
...
function heroAttack() {
  document.getElementsByClassName("skill-block")[0].style.visibility = "hidden";
    ...
    if (monster.alive) {
      ...
      setTimeout(function() {
        ...
        if (hero.alive == false) {
          ...
          document.getElementsByClassName("skill-block")[0].style.visibility= "initial";
        }
      }, 500);
    } else {finish();}
  }, 1100);
